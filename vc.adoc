...
`GET /api/virtual-classes/v3.0/content-providers/{provider}/worlds`
...
[source,highlightjs,highlight]
----
$ curl 'http://localhost:8080/api/virtual-classes/v3.0/content-providers/wichita/worlds' -i -X GET \
...
`GET /api/virtual-classes/v3.0/content-providers/{provider}/worlds/{worldId}`
...
[source,highlightjs,highlight]
----
$ curl 'http://localhost:8080/api/virtual-classes/v3.0/content-providers/wichita/worlds/test' -i -X GET \
    -H 'Accept: application/json' -H 'authorization: apiKey 0a47c3bf-4740-465d-a22e-0b25ef86ddd1'
----
...
`GET /api/virtual-classes/v3.0/content-providers/{provider}/worlds/{worldId}/videos`
...
[source,highlightjs,highlight]
----
$ curl 'http://localhost:8080/api/virtual-classes/v3.0/content-providers/wichita/worlds/test/videos' -i -X GET \
    -H 'Accept: application/json' -H 'authorization: apiKey 0a47c3bf-4740-465d-a22e-0b25ef86ddd1'
----
