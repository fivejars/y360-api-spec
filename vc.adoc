...
`GET /api/virtual-classes/v1.0/content-providers/{provider}/programs`
...
----
$ curl 'http://localhost:8080/api/virtual-classes/v1.0/content-providers/lmod/programs?exerciserUuid=8965a460-a79e-4bf7-b66c-7e34d8c34760&searchString=BODYSTEP&page=0&limit=50' -i -X GET \
...
`GET /api/virtual-classes/v1.0/content-providers/{provider}/programs/{programId}`
...
[source,highlightjs,highlight]
----
$ curl 'http://localhost:8080/api/virtual-classes/v1.0/content-providers/lmod/programs/44440?exerciserUuid=8965a460-a79e-4bf7-b66c-7e34d8c34760' -i -X GET \
    -H 'Accept: application/json' -H 'authorization: apiKey 0a47c3bf-4740-465d-a22e-0b25ef86ddd0'
----
...
`GET /api/virtual-classes/v1.0/content-providers/{provider}/programs/{programId}/videos`
...
[source,highlightjs,highlight]
----
$ curl 'http://localhost:8080/api/virtual-classes/v1.0/content-providers/lmod/programs/44440/videos?exerciserUuid=8965a460-a79e-4bf7-b66c-7e34d8c34760&page=0&limit=50' -i -X GET \
    -H 'Accept: application/json' -H 'authorization: apiKey 0a47c3bf-4740-465d-a22e-0b25ef86ddd0'
----
...
`GET /api/virtual-classes/v1.0/content-providers/{provider}/featured-videos`
...
[source,highlightjs,highlight]
----
$ curl 'http://localhost:8080/api/virtual-classes/v1.0/content-providers/lmod/featured-videos?exerciserUuid=8965a460-a79e-4bf7-b66c-7e34d8c34760&page=0&limit=50' -i -X GET \
    -H 'Accept: application/json' -H 'authorization: apiKey 0a47c3bf-4740-465d-a22e-0b25ef86ddd0'
----
...
`GET /api/virtual-classes/v1.0/content-providers/{provider}/videos`
...
[source,highlightjs,highlight]
----
$ curl 'http://localhost:8080/api/virtual-classes/v1.0/content-providers/lmod/videos?exerciserUuid=8965a460-a79e-4bf7-b66c-7e34d8c34760&searchString=RPM%20%2379%20Express&duration=SHORT&page=0&limit=50' -i -X GET \
    -H 'Accept: application/json' -H 'authorization: apiKey 0a47c3bf-4740-465d-a22e-0b25ef86ddd0'
----
...
`GET /api/virtual-classes/v1.0/content-providers/{provider}/videos/{videoId}`
...
|videoDetails.instructor |String |true |Instructor name.
|videoDetails.level |String |true |Workout level.
|videoDetails.equipment |String |true |Equipment needed for workout.
|videoDetails.presenter |String |true |Presenter of the video.
|videoDetails.location |String |false |Location metadata of the video (e.g. 'Wichita', 'Houston').
...
[source,highlightjs,highlight]
----
$ curl 'http://localhost:8080/api/virtual-classes/v1.0/content-providers/lmod/videos/375633?exerciserUuid=8965a460-a79e-4bf7-b66c-7e34d8c34760' -i -X GET \
    -H 'Accept: application/json' -H 'authorization: apiKey 0a47c3bf-4740-465d-a22e-0b25ef86ddd0'
----
...
`GET /settings/v1.0/content-providers/{provider}/app-settings`
...
[source,highlightjs,highlight]
----
$ curl 'http://localhost:8080/settings/v1.0/content-providers/wichita/app-settings?exerciserUuid=8965a460-a79e-4bf7-b66c-7e34d8c34760' -i -X GET \
    -H 'Accept: application/json' -H 'authorization: apiKey 0a47c3bf-4740-465d-a22e-0b25ef86ddd0'
----
...
`GET /settings/v1.0/content-providers/{provider}/app-settings/{key}`
...
[source,highlightjs,highlight]
----
$ curl 'http://localhost:8080/settings/v1.0/content-providers/wichita/app-settings/customKey1?exerciserUuid=8965a460-a79e-4bf7-b66c-7e34d8c34760' -i -X GET \
    -H 'Accept: application/json' -H 'authorization: apiKey 0a47c3bf-4740-465d-a22e-0b25ef86ddd0'
----
...
`GET /api/virtual-classes/{source}/v1.0/content-providers/{provider}/get-category-asset`
...
[source,highlightjs,highlight]
----
$ curl 'http://localhost:8080/api/virtual-classes/groupxclasses/v1.0/content-providers/wichita/get-category-asset?exerciserUuid=8965a460-a79e-4bf7-b66c-7e34d8c34760&id=9204039012020&name=Step Express&activity=Step Express' -i -X GET \
-H 'Accept: application/json' -H 'authorization: apiKey 0a47c3bf-4740-465d-a22e-0b25ef86ddd0'
----
